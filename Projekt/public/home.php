...
$recipes_result = Recipe::getAllRecipes($db->getConnection(), $category_filter, $search_filter);
?>
...
<nav>
    <div class="nav-wrapper">
        <div class="logo">
            <a href="home.php">
                <img src="../images/book.png" alt="Receptgyűjtemény" class="header-icon">
                Receptgyűjtemény
            </a>
        </div>
        <div class="menu">
...
<div class="content">
    <div class="filter">
        <form method="GET" action="home.php">
            ...
            <input type="text" name="search" placeholder="Recept név" value="<?= htmlspecialchars(isset($_GET['search']) ? $_GET['search'] : '') ?>">
    ...
    <div class="recipes">
        <?php if (count($recipes_result) > 0): ?>
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <p>Nincsenek receptek a megadott keresési feltételek alapján.</p>
        <?php endif; ?>
    </div>
</div>
</body>
